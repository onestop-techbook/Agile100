...
実はそれよりはるか昔にXP白本@<fn>{2} （XPの第２版のこと、以下XPE2nd）の参考文献に、サティア・ナデラ氏が経営陣に配った書籍であるNVC本@<fn>{3}が取り上げられているのをご存知でしょうか？
...
ＮＶＣが基盤としているのは、@<strong>{過酷な状況に置かれてもなお人間らしくあり続けるための言葉とコミュニケーションのスキル}である。
ＮＶＣがめざすのは、@<strong>{人と人は互いに関係を築けるものだという自覚を取り戻し、それを実践に移すためのお手伝い}をすることである。
//}
...
ＮＶＣはわたしたちに@<strong>{本来そなわっている力}──@<strong>{人を思いやる気持ち}を引き出すことで、自分自身と、そして自分以外の人々との交流を容易にする。@<strong>{自分自身を表現する方法、そして耳を傾ける方法}を見直すプロセスともいえる。
//}
...
NVC本の後に翻訳された『「わかりあえない」を超える』@<fn>{4}にNVCの２つの問いが紹介されています。
...
しかし、１つ目の問いである「内面で何が息づいている・生き生きしているか？」についてどれだけの人が意識的になっているでしょう？私たちは、外側の世界で何かやることばかりに目を奪われていて、@<strong>{内面にあるもの}については、あまりに無自覚ではないでしょうか。


NVCの２つの問いが示していることは、内面に目を向けて@<strong>{あるもの}を読み解かないと、いくら外側で何をしようとも、本当に望む所に行き着かないのではないか？ということです。
...
NVCでは、コミュニケーションを４つのステップで行います。観察→感情→ニーズ→リクエストの４つのステップを略称をとって@<strong>{OFNR}とも呼びます。
...
//footnote[2][ＫｅｎｔＢｅｃｋ & ＣｙｎｔｈｉａＡｎｄｒｅｓ. エクストリームプログラミング. (オーム社, 2015).]
