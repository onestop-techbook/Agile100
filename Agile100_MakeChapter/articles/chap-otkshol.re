...
初めての案件実施時には、疑問に思ったことをSlackに書き込むと答えられる人から回答をすぐ頂けたり、必要に応じて通話を繋いでサクッと解決したり、しかもその動きをチーム全員で補い合っており、なんて良いチームに来たんだ！と感じていました。
...
個人的な収穫もありました。「我々はなぜここにいるのか」を議論する際、やったことのないファシリテーション役を無茶振りして頂いたのですが、意外とやってみれば何とかなることを学びました。同時に、悩んでいる様子や喜んでいる様子が表に出過ぎる性質があるので、ファシリテーションをするときは議論の進める邪魔にならない程度にもう少し感情コントロールができるとより良いという課題も自覚することができました。普段の業務でファシリテーションスキルと向き合う機会があまりなかったので、貴重な経験になりました。

そして、初めて対面したチームメンバーとお昼に美味しいラーメンを一緒に食べた絆も手に入れることができました。（嬉しすぎて卵をためらうことなくトッピングし、いつもより豪華にしてしまった。）
