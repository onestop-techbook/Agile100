...
先程、「ふりかえり」にはいくつか手法があるとかきましたが、「定例会」に向いた「YWT」というやり方があります。これは「やったこと（Yattakoto）」、「わかったこと（akattakoto）」、「次やること（Tuginiyarukoto）」でふりかえる手法で、私は定例会で「まずは各自で今週やったことを共有してください。」とお願いして、各自が共有している時に「その時にわかったことや気づいたこと、考えたことはありますか？」と聞いていきました。そして一通り参加者が話した後で「では各自、次にやることはなんですか？もしくは次にやる時にはどんなやり方をしますか？どんな点に注意しますか？」と聞いていきました。
