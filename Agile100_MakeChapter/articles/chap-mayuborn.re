...
この章を読み進めていただくために、私のことを知っていただくことで、読んでいただく方との距離感が伝わればと思いますので、私の概要を記載したいと思います。
...
その時のソフトウェアは、PCで学年に応じた問題が出てきて、回答して答え合わせをするような、学習系のソフトウェアでした。
その他、大きなフロッピーディスクをドライブにセットしてPCを起動するような操作をしていた記憶があります。
幼いながらも、そのような操作の経験が出来たことはとても良かったです。
...
その後、PCとの関わりは遠のいていました。私の中で、テレビゲームへの気持ちが高くなって、テレビゲームのことを考えることが多くなっていました。


次にPCに関わりだしたのは、中学生のころで、家族がノートPCを購入してきました。そのノートPCで、ダイヤルアップ接続でインターネットを接続しました。


その頃は何か目的をもって操作していたというよりは、PCを操作することで起きる一つ一つの動作に心を動かされながら楽しむといったような関わり方でした。
その後、進路を考える時期になりました。自分の人生の中で振り返ったときに楽しかったこととして、PCを触ることが出てきました。あの時触ったようなソフトウェアが作れるようになりたい、という気持ちで進学先を決めました。
その先でも進路を考える時期が来た時に、PCのソフトウェアの中でも、ハードを動かすようなソフトを作ることに興味があり、組み込み系ソフトウェアの職業を目指そうと思いました。
現在その職業に就いていますが、今でもハードウェアが動くと嬉しく、そのことが楽しいため、私自身の好きなものの軸は変わっていないと思います。

=== アジャイルへの関わりについて


社会人となってから、AgileJapanへ参加する機会があり、参加致しました。
イベントには様々なブースがあり、とても活気がありました。とても注目されているということが伺えました。
私の中で印象深かった内容は、モブプログラミングの話でした。
そんな形でのアジャイルとの関わりがスタートしました。

== Agile Tech EXPOへの参加


2020年、コロナ禍となり、勉強会やイベントがオンラインで開催されるようになりました。そのことで、参加のハードルが下がり、何かイベントに参加したいと思うようになりました。
...
現在は、「雑談」と「あじゃてく読書会」で主にチャットしたりしています。
Agile Tech EXPOの開催時のみでなく、日常的にチャンネルが更新されています。更新されているチャンネルがあれば確認して、チャンネルを渡り歩いています。時々誰かの声掛けでボイスチャンネルで雑談が始まったりします。雑談は短時間で終わることが多いですが、世間話からコミュニティの話など色々話が出来てとても楽しいです。
ここの良さは、誰でも気軽に参加でき、受け入れてもらえる雰囲気が作られていることだと思っています。


何かを始めるにあたって、「一緒にやりましょう」と声をかけていただけることは、とても嬉しいことです。
そのようなちょっとした会話があじゃてくのdiscordで実現されています。
何かの行動を起こすための心のハードルをシームレスにしてもらえることは、良いことだと思います。
あじゃてく読書会は、私が普段あまり読まない本を読むきっかけになっていて、とてもありがたいです。
このサーバーに参加できていることは、私にとってとても価値があると思っています。
