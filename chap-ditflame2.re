...
//footnote[開発環境ランドスケープ][個人的にはSAP R/3やS/4HANAみたいに３システムランドスケープを置こう！みたいなレベル感で、複数ステージ環境強烈に
取れる方が良い面もあるというのは非常に理解できるところではあります。まあ、３環境も取るのはやり過ぎでは……という話もわかる所ではあるので、
現実的にはテスト/本番の２環境ぐらいに落ち着くのかなと思いますが。最近はいい時代になりましたよね……]
