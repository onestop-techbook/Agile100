...
== 背景
今よりもっとうまくソフトウェア開発したい。価値あるソフトウェアを利用者に届けたい。ソフトウェア開発を志す人ならば一度くらい、そんなことを考えたことがあるのではないでしょうか？そんなことができたら本当にどんなに素晴らしいことでしょう。でも現実は厳しく、誰かが（いつ？どんな目的で？）決めたのかよく分からない開発標準という枠組みの中で、あまり役に立たないと感じながらも決まり事だからと渋々、あるいは必死に不合理と戦い苦しんでいるケースも未だに多いかもしれません。そんな状況に当時の自分は耐えかねてソフトウェア開発から逃亡しよう画策しました。しかし、幸運にも（？）2008年秋に発生したリーマンショックで初めての転職と言う名の逃亡が見事に失敗した後、生きる（食つなぐ）ために再びソフトウェア開発の仕事に戻ることにしました。日々の作業に追われる中、2012年頃たまたま本屋で目にし、手に取ったのが書籍「アジャイルサムライ ― 達人開発者への道」でした。今から遡ること、約10年前のことでした。
 
衝撃的な内容に興奮して一気に読み終え、気になった部分をマーキングし、付箋を貼りまくったことを今でも覚えています。

== 初めてのアジャイル開発
当時は少し景気が悪かったことが幸いし、社内でアベっていた人員を活用して自社サービスのプロトタイプを開発するというプロジェクトが立ち上がりました。アジャイルサムライを読んで熱に浮かされていた私にとって、これは千載一遇のチャンスと感じました。上司に是非アジャイル開発でやらせて欲しいと懇願して、何とか受け入れてもらいました。今後は約2週間（スプリント）ごとに動くソフトウェアを届けますと（実際できるかどうか分からなかったけど）約束しました。当時のスタートアップ時の体制（ご近所さん達）はこんな感じでした。
...
序盤の躓きもありアジャイルごっこにもなってない状況で何度も挫折しかけました。しかし、相方に懇願して「ふりかえり」を継続して地道に軌道修正を続けたことで、何とかネチネチと続けることができました。当時、効果が高かった改善点の例としては下記が挙げられます。

@<strong>{・ご近所さん（プロジェクト関係者）の見える化}

ご近所さんの図を壁に貼り同じチームメンバだと再認識することで、課題解決に向けた建設的な相談がしやすくなった。また、スプリントの途中で動くものを見せて早い（そして忌憚のない）フィードバックをもらって軌道修正が可能になった。
...
成果に注目してくれた派遣先の現場でシニアエンジニア（顧客）を誘って2人で社外の勉強会へ参加して新たな知見や気付きを共に得て、あるべき姿について（飲みながら何度も）議論した。社外から講師を招待してチームやエンジニアに向けた勉強会を開催して成長や改善の糧となるインプットの場をつくった。Jenkinsを導入して、これまで手動で行っていたビルドやインストーラー作成などを自動化することで、エンジニアの作業負荷やストレスを低減し、尚且つヒューマンエラーによる品質低下も低減した。
...
@<strong>{Step3：社内でアジャイルを推進する役割（CoE）を2人で担う}
...
正しいアジャイル、スクラムかどうかを気にし（過ぎ）ないで欲しいです。確かに「アジャイルソフトウェア開発宣言」や原則や価値を理解することは重要だし、同様に理論を学ぶことも重要だと思う。ただ物事はゼロイチじゃなく、理想と現実の間でバランスを取っていくことが大切だと考えています。
アジャイル柱の（あの）平鍋氏も「（アジャイルなんて）今の仕事で使えないじゃん！」という境遇にかつて陥ったことがあり、そんな時「今の仕事を今よりうまくすることはできる。」という言葉に救われ、アジャイルに拘り過ぎることをやめ、アジャイルの要素を使って「いきいきと仕事がしたい」「お客さんと喜び合える仕事がしたい」と気持ちを切り替えたそうです。私もその言葉に何度も救われました。もし興味があれば下記の記事も読んでみてください。（実は私の記事ですw）

https://www.manaslink.com/articles/15011

== まとめ
これまでアジャイルを学び、拙いながら実践し続けてこれたのは、その時々で良き理解者（ファーストフォロワー）に恵まれたことが最大の要因だと思います。「ファーストフォロワー」を見つけて、まず「2人から始める」ことで、今日まで実践し続けることができました。運もあるかもしれませんが、自分の意志で前進し、試行錯誤して足掻き続けて困っている時、不思議と良いフォロワーに出会えることが多かったように思います。社内だけでなく、社外コミュニティなどでも、助けてくれるフォロワーはきっと居ると思います。そう信じて、まずは1人フォロワーを探して2人からアジャイルをはじめてみてはいかがでしょうか。
...
趣味はキャンプ△とサイクリング🚴。バスケはご無沙汰で最近は専らNBA観戦。
