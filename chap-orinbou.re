...
== 背景
今よりもっとうまくソフトウェア開発したい。価値あるソフトウェアを利用者に届けたい。ソフトウェア開発を志す人ならば一度くらい、そんなことを考えたことがあるのではないでしょうか？そんなことができたら本当にどんなに素晴らしいことでしょう。でも現実は厳しく、誰かが（いつ？どんな目的で？）決めたのかよく分からない開発標準という枠組みの中で、あまり役に立たないと感じながらも決まり事だからと渋々、あるいは必死に不合理と戦い苦しんでいるケースも未だに多いかもしれません。そんな状況に当時の自分は耐えかねてソフトウェア開発から逃亡しようと画策しました。しかし、幸運にも（？）2008年秋に発生したリーマンショックで初めての転職と言う名の逃亡が見事に失敗した後、生きる（食つなぐ）ために再びソフトウェア開発の仕事に戻ることにしました。日々の作業に追われる中、2012年頃たまたま本屋で目にし、手に取ったのが書籍「アジャイルサムライ ― 達人開発者への道」でした。今から遡ること、約10年前のことでした。
