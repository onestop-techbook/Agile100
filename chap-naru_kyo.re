...
そんな中当時の上司から「正しくアジャイルを行いたいのなら、資格を取って学んだ方がよい」という薦めもあり、2018年11月にスクラムマスターの研修を受講し、@<href>{https://www.scrumalliance.org/get-certified/scrum-master-track/certified-scrummaster, CSM} の資格を取得しました。

==== この時期をふりかえって

@<strong>{・まずは正しい知識の理解から。}



CSMの研修受講前に事前学習を行ったことで、アジャイル・スクラムについて正しい知識を学習できた。やっぱりベースとなる基礎知識をしっかり理解することは大事。

@<strong>{・アジャイルの「マインドセット」を学んだ。}
...
@<strong>{・キーノートセッションで、スクラムチームが成長していく過程を学んだ。}
...
@<strong>{・スクラムマスターとしての立ち位置を再認識できた。}
...
@<strong>{・スクラムマスターとしての立ち位置を再認識できた。（その２）}
