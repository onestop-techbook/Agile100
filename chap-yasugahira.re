...
スキルマップ自体の説明は、ryuzeeさんのブログエントリ@<href>{https://www.ryuzee.com/contents/blog/7065, スキルマップ作成のすすめ}をご覧ください。

//footnote[agility][この記事において「チームのアジリティ」とは、メンバが何かを提案してから、チームとして合意して具体的なアクションに繋げるまでの期間を指しています。この定義は私の勝手なイメージなで出典はないので、一般的なイメージと異なっていたらすみません。。。なおチームのアジリティという考え方は、広木さんの@<href>{https://dxd2021.cto-a.org/program/time-table/b-6, 『2つのDX』とDX Criteria 2021}という講演を拝見して思いついた考え方です。]
...
//image[level][他のロールのスキルを有したスキルマップ例][scale=0.7]
