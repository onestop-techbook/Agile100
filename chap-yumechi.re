...
これらの理由により、このプロジェクトではウォーターフォールを選んだことは適切でした。
...
チームメンバーの数は時期によって変動していますが、私を含めて４～６名です。
...
成果から課題を出すことで、活動に裏打ちされた本質的な問題が出やすくなったと感じています。
...
ふりかえりの目的を達成するために考え抜いた結果、FLAPに現在は落ち着きましたが、メンバーの変化やフェーズの変化によってふりかえりの手法・進め方を見直していきたいです。

また、自分の中ではKPT, YWTに納得できてなかった部分を解決できるフレームワークが見つかり嬉しく思います。
今後も試せる場があれば、ふりかえりの目的に合わせて、さまざまなフレームワークを試し、効率的なふりかえりを実現していきたいです。
