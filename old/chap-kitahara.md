...
具体的には、デイリースクラム後にリファイメントを45分やる事にして、デイリースクラムと合わせて1時間の枠行いました。
...
また副次的な効果として、デイリースクラムの直後にあらかじめ予定が組まれていることで15分以内に終わらせる意識が強くなり、つい課題共有から検討が始まってがデイリースクラムの時間がずるずると伸びてしまうことも無くなりました。
...
結局のところ、スプリントバックログアイテムをすべてDoneにする。という当たり前のことが出来ていないのは、正しくスクラムを行っていない事が原因だったので、基本に立ち返って

上手くいかない時こそスクラムガイドに忠実であるか見直す事が大切
