...
== 「反復」とは何か
人間は「反復」によって多くの技能を獲得します。スポーツでも習字でも音楽でもそうですが、反復練習なくして上手になることはありません。そして、反復周期は短いほど、つまり頻度が高いほど一般に練習の効果は高いです。年に1回ピアノを弾いたってなかなか上達はしません。が、週に1回、できれば毎日練習するほうが上達は早いものです。
...
この状態に陥っているチームは、プロダクト開発そのもの以外もうまく行きません。なぜなら、上述したとおり人間は反復によって技能を獲得するからです。例えば心理的安全性にしても、自己組織化にしても、Ｔ字型スキルにしても、「反復（イテレーション）」をする中で徐々に習得されていくものだからです。
...
実は、プロダクトバックログづくりは新しく作ったチームが最初にぶつかる壁のひとつです。図４に示したアンチパターン以外にも、プロダクトバックログアイテムのサイズが大きすぎて、完成までに１ヶ月～数ヶ月かかるというのもよく見かけます。インクリメントが付加する価値は、上述したように「ボタンを押すとランプが点く」ぐらいの、本当に小さなもので良いのです。試してみてください。
 ...
 * アジャイル開発において、反復がうまく行っている指標は、毎回のイテレーション（スプリント）でデモができることである。
